 ...
 function conf(a, b) {
        pxmu.diaglog({
            ...
            btn: {
                left: {
                    text: '取消', //左侧按钮文本内容
                    color: 'rgba(111, 109, 133, 0.95)', //左侧按钮颜色
                    fontsize: 19, //左侧按钮字体大小
                    fontweight: 'normal', //左侧按钮是否加粗 bold加粗 normal不加粗
                    bg: 'rgba(245, 230, 229,1)', //左侧按钮背景色
                    solid: 0, //左侧按钮描边粗细
                    solidcolor: 'rgba(111, 109, 133, 0.8)', //左侧按钮描边颜色
                },
                right: {
                    text: '确认', //左侧按钮文本内容
                    color: 'rgba(111, 109, 133, 0.93)', //左侧按钮颜色
                    fontsize: 19, //左侧按钮字体大小
                    fontweight: 'normal', //左侧按钮是否加粗 bold加粗 normal不加粗
                    bg: 'rgba(233, 240, 240,0.9)', //左侧按钮背景色
                    solid: 0, //左侧按钮描边粗细
                    solidcolor: 'rgba(111, 109, 133, 0.8)', //左侧按钮描边颜色
                }
            },
            congif: {
                ...
                animation: 'slideup', //显示的动画 默认无动画 动画支持详见动画文档
            }
        }).then(function(res) {
            // 返回结构
            if (res.btn == 'right') {
    ...
    function warn(a) {
        pxmu.toast({
            ...
            bg: 'rgba(219, 246, 253, 0.86)', //背景颜色 默认黑色
            color: 'rgba(111, 109, 133, 0.8)', //文字颜色 默认白色
            location: 'top', //居中center 顶部top 底部bottom默认
            animation: 'slideup', //显示的动画 默认fade 动画支持详见动画文档
        });
    };
    (function (w) {
